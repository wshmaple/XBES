...
#define soap_write_ns__GetInfo(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__GetInfo(soap, data), 0) || soap_put_ns__GetInfo(soap, data, "ns:GetInfo", NULL) || soap_end_send(soap) )
#endif
...
#define soap_read_ns__GetInfo(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__GetInfo(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__GetInfo * SOAP_FMAC4 soap_get_ns__GetInfo(struct soap*, struct ns__GetInfo *, const char*, const char*);

#define soap_new_ns__GetInfo(soap, n) soap_instantiate_ns__GetInfo(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__GetInfo(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__GetInfo * SOAP_FMAC2 soap_instantiate_ns__GetInfo(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__GetInfo(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__GetInfoResponse
#define SOAP_TYPE_ns__GetInfoResponse (10)
#endif
...
#ifndef soap_write_ns__GetInfoResponse
#define soap_write_ns__GetInfoResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__GetInfoResponse(soap, data), 0) || soap_put_ns__GetInfoResponse(soap, data, "ns:GetInfoResponse", NULL) || soap_end_send(soap) )
#endif
...
#ifndef soap_read_ns__GetInfoResponse
#define soap_read_ns__GetInfoResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__GetInfoResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif
...
#define soap_new_ns__GetInfoResponse(soap, n) soap_instantiate_ns__GetInfoResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__GetInfoResponse(soap, p) soap_delete(soap, p)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__GetInfoResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
