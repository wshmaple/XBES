...
struct MemoryEditor
{
    ...
    void DisplayPreviewData(size_t addr, const u8* mem_data, size_t mem_size, DataType data_type, DataFormat data_format, char* out_buf, size_t out_buf_size) const
    {
        ...
        if (data_format == DataFormat_Bin)
        {
            ...
            snprintf(out_buf, out_buf_size, out_buf_size, "%s", FormatBinary(buf, (int)size * 8));
            return;
        }
        ...
        case DataType_S8:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%hhd", int8); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%02x", int8 & 0xFF); return; }
            break;
        }
        case DataType_U8:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%hhu", uint8); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%02x", uint8 & 0XFF); return; }
            break;
        }
        case DataType_S16:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%hd", int16); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%04x", int16 & 0xFFFF); return; }
            break;
        }
        case DataType_U16:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%hu", uint16); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%04x", uint16 & 0xFFFF); return; }
            break;
        }
        case DataType_S32:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%d", int32); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%08x", int32); return; }
            break;
        }
        case DataType_U32:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%u", uint32); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%08x", uint32); return; }
            break;
        }
        case DataType_S64:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%lld", (long long)int64); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%016llx", (long long)int64); return; }
            break;
        }
        case DataType_U64:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%llu", (long long)uint64); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "0x%016llx", (long long)uint64); return; }
            break;
        }
        case DataType_Float:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%f", float32); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "%a", float32); return; }
            break;
        }
        case DataType_Double:
        {
            ...
            if (data_format == DataFormat_Dec) { snprintf(out_buf, out_buf_size, out_buf_size, "%f", float64); return; }
            if (data_format == DataFormat_Hex) { snprintf(out_buf, out_buf_size, out_buf_size, "%a", float64); return; }
            break;
        }
        } // Switch
