...
{
public:
	std::string ConfigInfo;	/* required element of type xsd:string */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__GetInfo(struct soap*, std::string ConfigInfo, std::string &result);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__GetInfo(struct soap *soap, const char *soap_endpoint, const char *soap_action, std::string ConfigInfo, std::string &result);
